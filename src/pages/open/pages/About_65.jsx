...
const About_65 = () => {
  return (
    <>
      <Header_65 />
      <div class='wild-oasis'>
        <div class='antialiased bg-primary-950 text-primary-100 min-h-screen flex flex-col relative'>
          <div class='flex-1 px-8 py-12 grid'>
            <main class='max-w-7xl mx-auto w-full'>
              <div class='grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center'>
                <div class='col-span-3'>
                  ...
                  <div class='space-y-8'>
                    <p className='text-left'>
                      ...
                      Dolomites, this is your paradise away from home. But it's
                      not just about the luxury cabins. It's about the
                      experience of reconnecting with nature and enjoying simple
                ...
                <div class='relative aspect-square col-span-2'>
                  <img
                    alt='Family that manages The Wild Oasis'
                    class='absolute h-full w-full text-transparent object-cover'
                    sizes='100vw'
                ...
                <div class='col-span-3'>
                  ...
                  <div class='space-y-8'>
                    ...
                    <p className='text-left'>
                      ...
                      Oasis, blending the timeless beauty of the mountains with
                    ...
                    <div>
                      <Link
                        to='/cabins'
                        class='inline-block mt-4 bg-amber-300 px-8 py-5 text-primary-800 text-lg font-semibold hover:bg-amber-500 transition-all'
                      >
