...
[https://github.com/Aurora765/1122-wp2-2N-65](https://github.com/Aurora765/1122-wp2-2N-65)
...
[My Github repo URL for demo](https://github.com/Aurora765/1122-wp2-2N-65)
...
```
f1b4910 Aurora76501~    Wed Jun 12 19:18:52 2024 +0800  Show Your Github Repo for all md and demo01
```
...
[My Github URL for git logs](https://github.com/Aurora765/1122-wp2-2N-65/commits/main/)
...
```
e087cfc Aurora76501~    Wed Jun 12 19:23:12 2024 +0800  P1-2: Show all your git logs from W10 to W15
...
[w15 demo deploy to Vercel](https://w15-chi.vercel.app/)
...
```
37db776 Aurora76501~    Wed Jun 12 19:31:23 2024 +0800  P1-4: 透過 P1-3 之程式登入後取得 Supabase access token, api keys
```
...
```
a9f7f01 Aurora76501~    Wed Jun 12 20:23:04 2024 +0800   P2: 實作路由 /about_xx，點選上方選單 About_xx，可以顯示 About 訊息如下圖
```
...
```
3549344 Aurora76501~    Wed Jun 12 21:35:26 2024 +0800  P3: 請實作 /cabins_xx/:id，當點選 Details and reservation 時，顯示該 cabin id 的詳細資訊，如
下圖。
```
...
```
af4843a Aurora76501~    Wed Jun 12 20:57:52 2024 +0800  P4-1: 請在 Supabase 加入一筆有你
```
...
```
0810b86 Aurora76501~    Wed Jun 12 21:45:04 2024 +0800  CabinById.jsx 相關的 code
```
